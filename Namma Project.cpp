...
void ParkingManagement::park(ParkingManagement obj)
{
    ...
    if (count >= 10) {
        cout << "Parking is full. No more spaces available." << endl;
        return;
    }

    cout << "There are total " << (10 - count) << " spaces available in the parking space." << endl;
    cout << "---------------------------------------------------";
    cout << "---------------------------------------------------" << endl;
    ...
    out << "Car Name: " << CAR[count].carname << ", Car Id: " << CAR[count].carid << "\n"
        << "Driver Name: " << CAR[count].drivername << ", Car Time Stay: " << CAR[count].timestay << " hours\n";
...
void ParkingManagement ::addexpensedb(car CAR[], int count)
{
    ...
    out << "Driver Name : " << CAR[count].drivername << ", Car Time Stay : " << CAR[count].timestay
        << " hours, Total Expense : " << CAR[count].timestay * 10 << " Rupees\n";
...
void ParkingManagement::fetchData()
{
    system("CLS");
    ifstream inFile("carparkdb.txt");
    if (inFile.is_open())
    {
        string line;
